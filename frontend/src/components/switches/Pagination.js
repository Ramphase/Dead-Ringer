...
const Pagination = ({pages, setCurrentPage, currentSwitches, sortedSwitches}) => {
    ...
    return (
        ...
        <span span style={{color :'white', fontSize: 20}}>
            <div className="hint-text">Showing <b>{currentSwitches.length}</b> out of <b>{sortedSwitches.length}</b> entries</div>
        </span>
